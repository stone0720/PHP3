...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('san-pham.store') }}" method="POST" class="m-3" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file " id="img_san_pham" name="img_san_pham"
                        onchange="showImage(event)">
                    <br>
                    <div class="text-align:center">
                        <img id="img_product" src="" alt="Hình ảnh sản phẩm" style="width:150px; display: none;">
                    </div>
                </div>
                <div class="form-group">
                    <label for="ten_san_pham">Tên sản phẩm:</label>
                    <input type="text" class="form-control @error('ten_san_pham') is-invalid @enderror" id="ten_san_pham"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('ma_san_pham') is-invalid @enderror" id="ma_san_pham"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('so_luong') is-invalid @enderror" id="so_luong"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="mota" id="" cols="30" rows="3">{{ old('mota') }}</textarea>
                </div>
                <div class="form-group">
